## DIFFERENCE OF MYSQL AND POSTGRESQL
- __MySQL__ emphasizes simplicity, speed for read‑heavy workloads, and a large ecosystem; it is often chosen for web applications that need quick setup and high throughput on simple queries.

- __PostgreSQL__ emphasizes standards compliance, extensibility, and powerful query capabilities; it is preferred when you need complex queries, custom data types, or advanced features like GIS support.


## DIFFERENCE OF WEBSOCKETS AND WEBHOOKS
